...
\begin{frame}{Why This Matters}
  ...
  drives users away \cite{brady2017,beknazar2025}.
  ...
  \begin{columns}[T]
    \begin{column}{0.50\textwidth}
      \begin{alertblock}{Amplification threshold}
        ...
        \qquad \boxed{\alpha_{\mathrm{crit}} \approx 0.3165}
        \]
      \end{alertblock}
    ...
    \begin{column}{0.48\textwidth}
      \begin{greenblock}{Spread block: well-identified}
        \begin{itemize}
          ...
          \item Full-window $R^2 = 0.92$, narrow bootstrap CIs
          \item Beats SIR benchmark (spike-window $R^2 = 0.89$ vs.\ $0.69$)
        \end{itemize}
      \end{greenblock}
    \end{column}
    \begin{column}{0.48\textwidth}
...
\begin{frame}{Takeaways}
  \begin{enumerate}
    ...
    ($\alpha_{\mathrm{crit}} \approx 0.3165$). Below it, no sustained virality.
